    ...
    <div className="container">
      <div style={{ width: isOpen ? "300px" : "70px" }} className="sidebar">
        ...
        {menuItem.map((item, index) => (
          <NavLink
            ...
            style={{
              border: "1px solid",
              borderImageSource:
                "linear-gradient(116.48deg, #5A5A5A 1.7%, rgba(99, 99, 99, 0) 85.9%)",
              borderImageSlice: 1,
              borderRadius: "0px",
            }}
          >
        ...
        <NavLink
          ...
          className="link"
          activeclassName="active"
          style={{ marginTop: "17rem", flexDirection: "column", gap: "1rem" }}
        >
          <div className="icon">
            <Box
              style={{
          ...
          <div style={{ display: isOpen ? "block" : "none" }}>
            ...
            >
              <Fab
                variant="extended"
                style={{ background: "white", height: "1.7rem", width: "100%" }}
              >
                DOCUMENTATION
              </Fab>
            </div>
